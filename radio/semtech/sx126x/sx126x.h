...
/*!
 * Change the value on the device internal trimming capacitor at XTA pin
 */
#define REG_XTA_TRIM                                0x0911

/*!
 * Change the value on the device internal trimming capacitor at XTB pin
 */
...
void SX126xSetRxAtPreciseHSTime( uint32_t time, uint32_t timeout );
