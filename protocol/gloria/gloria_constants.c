...
const gloria_timings_t gloria_timings[] = {
    ...
    { // 10 (FSK 250k)
        ...
        .txSync = 3398, // 424.75 us (txSync from 9 + 24us (measured and calculated) preamble increased 2->8 bytes & duration of preamble and syncword changed due to different bitrates)
    },
};
